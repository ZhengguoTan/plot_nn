...
\begin{document}
	\begin{tikzpicture}
		...
		\node[font=\Large, rotate=90] at (\startx+0.5,4) {Physics-based simulated signal};
		...
		\draw[->, gray, thick, dashed, line width=2pt] (6.5, 9) -- (1.5, 9);
		\draw[->, gray, thick, dashed, line width=2pt] (12, 9) -- (17.0, 9);

		\node[text=black, font=\large] at (9.25,9) {\textbf{Loss Calculation}};
	\end{tikzpicture}
\end{document}
